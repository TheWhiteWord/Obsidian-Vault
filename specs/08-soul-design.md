...
|---|---|---|---|
| `manager` | the vault manager — keeps the vault healthy (structure, health, growth); holds no content | systems thinker; verifies before acting; raises findings; keeps machinery visible | *(pre-enrichment — see tracker)* |
